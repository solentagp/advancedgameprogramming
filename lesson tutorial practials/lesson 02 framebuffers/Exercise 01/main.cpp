...
char					g_TutorialName[100] = "SWD304 - Tutorial 01 Exercise 01\0";
...
void	ShutdownD3D			();void	RenderFrame			();HRESULT InitialiseD3D		()
{
	...
	hr = 
	g_pD3DDevice->CreateRenderTargetView(pBackBufferTexture, 
										 NULL,
										 &g_pBackBufferRTView);
...
void RenderFrame()
{
	...
	// test code to gradually change the clearing colour
	static float r = 0.1f;
	r += 0.0001f;
	if ( r > 1.0 ) r = 0;
